...
"""End-to-end CPU performance guard for DeepSeek-V4 CP metadata planning."""
...
@pytest.mark.cpu
def test_dsv4_cp_plan_1m_headtail_metadata_performance():
    """Guard DSV4-specific window/compression/routing work at 1M / CP128."""
    ...
    # Lightweight semantic checks keep this a performance guard rather than a
    # duplicate of the detailed CP planner correctness suite.
