...
class HcPre(Module):
    ...
    def forward_with_pre_mix(self, x, pre_mix=None):
        """Compute this block's mixes and collapse with the preceding mix.

        DeepSeek-V4 uses the mix generated by the previous sub-block as the
        input projection for the current sub-block.  ``pre_mix=None`` keeps
        the historical standalone behavior and uses the mix generated from
        ``x`` itself.
        """
